export const MECHANICS = {
  ...
  chord: { name: 'Chord', summary: 'In battle, play a Chord card on a revealed number after correctly flagging exactly that many adjacent mines. Honest Puzzle Minesweeper lets you tap the number directly. Every other neighbor opens; matching the count with flags on the wrong tiles detonates the exposed mines.', related: ['flag', 'reveal', 'energy'] },
