export const MECHANICS = {
  ...
  sentry: { name: 'Sentry', summary: 'A Construct that deals its listed damage to a random enemy when it triggers. It builds Heat and overloads if crowded with other Constructs. Stone Choir makes it trigger twice.', related: ['construct', 'heat', 'stone choir', 'board attack'] },
  ...
  'survey relay': { name: 'Survey Relay', summary: 'A Construct that draws 1 Energy at turn start to run — or goes offline that turn — then Scans one random hidden tile within radius 2 and grants its listed Block. It gains Heat as it runs. Stone Choir makes it trigger twice.', related: ['construct', 'scan', 'heat', 'stone choir'] },
  heat: { name: 'Heat', summary: 'Sentries and Survey Relays build Heat each turn, plus 1 more for every other heat-Construct within radius 2. A lone Construct cools off and stays reliable; clustered Constructs overheat. At maximum Heat a Construct overloads: it skips its trigger for the turn and vents Heat into nearby Constructs, which can chain across a tight cluster. Spread them out to keep cool. Bulwarks run cool and never build Heat.', related: ['sentry', 'survey relay', 'construct'] },
