export const MECHANICS = {
  ...
  'blast chain': { name: 'Blast Chain', summary: 'The Sapper’s count of controlled detonations during the current turn. Each link grants 3 Block and powers chain payoffs. The circular turn symbol on its tracker warns that the count resets at turn start.', related: ['sapper', 'detonate', 'block'] },
