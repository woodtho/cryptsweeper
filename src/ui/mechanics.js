export const MECHANICS = {
  ...
  light: { name: 'Light', summary: 'The Lamplighter’s resource. Cascades of 2 or more tiles generate Light and 3 Block per Light; larger cascades make more. Half of unpreserved Light normally fades at turn start, and flare cards spend it. Everburning Wick prevents this fading.', related: ['lamplighter', 'reveal', 'energy', 'block'] },
