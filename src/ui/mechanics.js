export const MECHANICS = {
  ...
  resonance: { name: 'Resonance', summary: 'A periodic boss intent that reacts to the selected Delver. Its telegraph names a target tied to that Delver’s signature resource or action. Meeting it creates an advantage; ignoring it causes a class-specific penalty.', related: ['turn', 'boss', 'sapper', 'surveyor', 'terraformer', 'lamplighter', 'gambler', 'chirurgeon', 'archivist', 'warden', 'hexwright', 'revenant'] },
  ...
  insight: { name: 'Insight', summary: 'A Surveyor combat resource capped at 10, gained from new safe discoveries and spent by Surveyor cards. The strongbox symbol on its battle tracker means the displayed amount is banked and remains until spent.', related: ['scan', 'reveal', 'surveyor'] },
  'blast chain': { name: 'Blast Chain', summary: 'The Sapper’s count of controlled detonations. Each link grants 3 Block and powers chain payoffs. Shockwave counts up to 10 links. The circular turn symbol means the chain normally resets at turn start; Daisy Chain instead retains up to 2 unused links.', related: ['sapper', 'detonate', 'block'] },
  light: { name: 'Light', summary: 'The Lamplighter’s resource. Cascades of 2 or more tiles generate Light and 4 Block per Light; larger cascades make more. Half of unpreserved Light normally fades at turn start, and flare cards spend it. On the battle tracker, the half-moon symbol means this fade is pending; a lock and number show how much Light is protected. Everburning Wick prevents fading.', related: ['lamplighter', 'reveal', 'energy', 'block'] },
  ...
  loaded: { name: 'Loaded', summary: 'The Gambler’s cheating resource, normally capped at 3. Correct manual flags earn Loaded; Stacked Deck spends it to force Wagers to Heads, with at most 5 forced Wagers queued. On the battle tracker, a checked coin means no rig is queued; the crooked die and its number count upcoming Wagers already forced to Heads. Two-Headed Coin raises the Loaded cap to 4.', related: ['gambler', 'wager', 'flag'] },
  ...
  'untreated blood': { name: 'Untreated Blood', summary: 'Recoverable wounds created by Chirurgeon Blood costs. Triage and treatment consume this ledger as they restore Health, preventing the same wound from being recovered repeatedly. The mending-drop symbol on the tracker identifies the number as recoverable. Lifesteal and emergency medicine can still heal beyond the ledger.', related: ['blood', 'chirurgeon', 'health'] },
  ...
  archive: { name: 'Archive', summary: 'The Archivist’s combat-only filed-card pile. Filed cards leave the draw cycle until a Recall effect returns them. The quotation-mark symbol and adjacent number on the tracker show banked Citations separately from the Archive count.', related: ['archivist', 'file', 'recall', 'citation'] },
  ...
  resolve: { name: 'Resolve', summary: 'The Warden’s combat resource. Enemy damage absorbed by Block or Plating creates Resolve, which Riposte cards convert into defense or damage. The shield-and-arrow symbol on the tracker marks Resolve as stored Riposte fuel.', related: ['warden', 'block', 'plating', 'riposte'] },
  ...
  rune: { name: 'Rune', summary: 'A Hexwright value inscribed beside a truthful revealed number. Rune values can be warped without changing the real Minesweeper clue. The star-rune symbol and adjacent number on the tracker show total power across every active Rune; Proof of Harm counts up to 45 Rune Power.', related: ['hexwright', 'inscribe', 'reveal'] },
  ...
  grave: { name: 'Grave', summary: 'The Revenant’s combat-only pile for Grave cards. Rise effects return those cards upgraded; each individual card can Rise only once. The upward grave-arrow symbol on the tracker means the displayed cards are available to Rise effects.', related: ['revenant', 'rise', 'exhaust'] },
  ...
  cursed: { name: 'Cursed Enemy', summary: 'An enemy modifier that adds a temporary named Curse to the combat discard pile. It can enter a later hand and Exhausts at end of turn.', related: ['deck', 'exhaust'] },
