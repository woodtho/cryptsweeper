export const MECHANICS = {
  ...
  insight: { name: 'Insight', summary: 'A combat resource gained from new safe discoveries and spent by Surveyor cards. The strongbox symbol on its battle tracker means the displayed amount is banked and remains until spent.', related: ['scan', 'reveal', 'surveyor'] },
  'blast chain': { name: 'Blast Chain', summary: 'The Sapper’s count of controlled detonations. Each link grants 3 Block and powers chain payoffs. The circular turn symbol means it normally resets at turn start; Daisy Chain instead retains up to 2 unused links.', related: ['sapper', 'detonate', 'block'] },
  ...
  rune: { name: 'Rune', summary: 'A Hexwright value inscribed beside a truthful revealed number. Rune values can be warped without changing the real Minesweeper clue. The star-rune symbol and adjacent number on the tracker show the total power across every active Rune.', related: ['hexwright', 'inscribe', 'reveal'] },
