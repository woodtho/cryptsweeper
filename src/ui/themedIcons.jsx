...
const ITEM_MARKS = {
  ...
  daisychain: <Mark><path d="M9 8 L7 6 Q4 3 2 6 Q1 8 4 11 L6 13 M15 16 L17 18 Q20 21 22 18 Q23 16 20 13 L18 11 M7 17 L17 7 M8 12 L12 16 M12 8 L16 12" /></Mark>,
  bottomlessledger: <Mark><path d="M5 4 H18 V20 H5 Z M8 7 H15 M8 11 H15 M8 15 H13 M18 6 H21 V22 H8 M3 8 H5" /></Mark>,
  coolantcell: <Mark><path d="M12 2 V22 M4 7 L20 17 M20 7 L4 17 M8 4 L12 8 L16 4 M8 20 L12 16 L16 20 M3 11 L8 12 L5 16 M21 11 L16 12 L19 16" /></Mark>,
  everburningwick: <Mark><path d="M8 21 H16 M9 18 H15 V10 H9 Z M12 10 Q7 7 12 2 Q17 7 12 10 M12 2 Q11 7 14 8 M7 14 H9 M15 14 H17" /></Mark>,
  twoheadedcoin: <Mark><circle cx="12" cy="12" r="9" /><path d="M8 8 Q10 6 12 8 Q14 6 16 8 M8 16 Q10 18 12 16 Q14 18 16 16 M12 5 V19 M5 12 H8 M16 12 H19" /></Mark>,
  leechkit: <Mark><path d="M12 2 Q18 9 18 14 Q18 21 12 21 Q6 21 6 14 Q6 9 12 2 M8 10 L4 7 M16 10 L20 7 M8 16 L4 19 M16 16 L20 19 M10 13 H14" /></Mark>,
  masterindex: <Mark><path d="M4 6 H17 V21 H4 Z M7 3 H20 V18 H17 M8 10 H14 M8 14 H14 M8 18 H12 M17 5 H21 M17 9 H21 M17 13 H21" /></Mark>,
  spikedaegis: <Mark><path d="M12 3 L18 6 V13 Q17 19 12 22 Q7 19 6 13 V6 Z M12 7 V18 M8 11 H16 M6 7 L2 5 M18 7 L22 5 M6 14 L2 16 M18 14 L22 16" /></Mark>,
  cinderbrand: <Mark><path d="M12 3 V16 M8 7 H16 M9 16 H15 L17 21 H7 Z M12 3 Q7 7 10 11 Q12 9 12 6 Q17 10 14 14" /></Mark>,
  secondshroud: <Mark><path d="M5 21 Q5 6 12 3 Q19 6 19 21 M8 12 Q8 8 12 8 Q16 8 16 12 V16 H8 Z M10 12 H10 M14 12 H14 M10 16 L12 14 L14 16" /></Mark>,
...
const ITEM_BASE = {
  ...
  daisychain: 'tool', bottomlessledger: 'card', coolantcell: 'charm', everburningwick: 'lamp',
  twoheadedcoin: 'compass', leechkit: 'kit', masterindex: 'card', spikedaegis: 'armor',
  cinderbrand: 'tool', secondshroud: 'charm',
